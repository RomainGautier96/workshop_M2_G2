...
setTimeout(() => {
	document.querySelector("#minipres > div > form > div > fieldset:nth-child(7) > ul > li:nth-child(1) > input").click();	
	setTimeout(() => {
...
<div style="background-color: black; width: 100%; height: 100%; position: absolute;  z-index: 1; padding: 0 !important; opacity: 0.95;">
    ...
    <h1 style="padding-top: 300px"> Etape : Choix de votre base ...</h1>
</div>
